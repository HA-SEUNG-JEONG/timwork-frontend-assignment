        ...
        <div className="flex flex-col gap-4 mb-4">
            <div className="flex gap-4">
                <div>
                    ...
                    <select
                        ...
                        className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md disabled:cursor-not-allowed disabled:opacity-30"
                    >
                ...
                <div>
                    ...
                    >
                        ...
                        {availableRevisions.map((r: Revision) => {
                            const isLatest = isLatestRevision(
                                r,
                                availableRevisions,
                            );
                            return (
            ...
            {hasDisciplineNoRevisions && (
                ...
                >
                    ...
                    <span>
                        선택한 공종({selectedDiscipline.name})에 등록된 리비전이
                        없습니다.
                    </span>
                </div>
            )}
