...
### 투명도 조절 및 줌인/줌아웃 수치 입력

- 투명도를 조절하는 UI 및 줌인/줌아웃을 구현할 때 수치를 직접 입력하는 부분도 고려했지만, 건설 현장에서 직접 수치를 입력할 가능성이 있을지에 대해 의문이 들었습니다. 시간 관계 상 슬라이더로만 구현했지만 시간이 더 된다면 레이아웃 설계와 함께 개선할 부분을 고민할 것입니다.
